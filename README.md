...
* So, For local PC All the process is same as VPS: You have to start from [⚙️ Pre-Requirements](https://github.com/Avinashtok/Fast-Sync-Your-0G-Node-Mr_Bear-Edition-#-pre-requirements)
